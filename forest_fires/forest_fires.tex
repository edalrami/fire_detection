...
% in the abstract
\begin{abstract}
This paper focuses on the predicting forest fire behavior using a
variety of weather and meteorological data. The study incudes data from
517 forest fires in the Montesinho Natural Park in Northern Portugal
from Janurary 2000 to December 2003. We look to draw a linear
relationship between predictor variables (weather and meteorlogical
data) and the Initial Spread Index (ISI) as our response variable. The
Inital Spread Index, ranging from 0 to 56, refers to the rate of spread
of a fire. Serving as an efficient measure of potential fire danger, a
high ISI also indicates higher difficulty of fire control in a given
region. In this paper we will test for multicolinearily between the
predictor variables, examine outliers, transform data, and stepwise
regression to select the most optimal features for a linear regression
model.
\end{abstract}
